...
import { ContainerHeader, BoxCollor, SubContainer, ContainerAccount, TextName, ButtonArrow, Navigator, TextNavigator } from './styles';
...
const HeaderModules: React.FC<Props> = ({ toggleTheme }) => {
        ...
        <ContainerHeader>
            ...
            <SubContainer>
                ...
                <ContainerAccount>
                    ...
                    <ButtonArrow onClick={() => toggleSidebar()}>
                        <MdOutlineKeyboardArrowDown size={30} color="#636466" />
                    </ButtonArrow>
                </ContainerAccount>

                <div className={toggle ? "submenu-close" : "submenu"}>
                    <Link to={'/account'}>
                        <Navigator>
                            <AiOutlineUser size={30} color='#000' />
                            <TextNavigator>Meu perfil</TextNavigator>
                        </Navigator>
                    </Link>

                    <Link to={'/support'}>
                        <Navigator>
                            <FaLifeRing size={30} color='#000' />
                            <TextNavigator>Suporte</TextNavigator>
                        </Navigator>
                    </Link>
                    <Link to={'/logout'}>
                        <Navigator>
                            <BiExit size={30} color='#000' />
                            <TextNavigator>Sair</TextNavigator>
                        </Navigator>
                    </Link>
                </div>
            </SubContainer>
